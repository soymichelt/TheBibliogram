...
Friend Class CryptoSecurityInfo
    ...
    Public Shared Function PasswordEnconding(ByVal ValText As String) As String
        ...
        Using RSA As New RSACryptoServiceProvider
            RSA.FromXmlString(CryptoSecurityInfo.KeyPublic)
            Return Convert.ToBase64String(RSA.Encrypt(CryptoSecurityInfo.Converter.GetBytes(ValText), False))
        End Using
    End Function
    ...
    Public Shared Function PasswordDecoding(ByVal ValText As String) As String
        ...
        Using RSA As New RSACryptoServiceProvider
            RSA.FromXmlString(CryptoSecurityInfo.KeyPrivate)
