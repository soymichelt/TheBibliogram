@Code
    ViewData("Title") = "Préstamos por Tipo de Persona"
                    ...
                    <div class="col-md-12">
                        <form id="FormParametros">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="input-group has-success">
                                        <label for="TipoPersona" class="input-group-addon input-title-theme">T. Persona</label>
                                        <select id="TipoPersona" name="TipoPersona" class="form-control" required>
                                            @For Each c In AppWeb.Globales.TipoPersona
                                                @<option class="option-theme" value="@c.N">@c.Nombre</option>
                                            Next
                                        </select>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnLoadReport").click(function (e) {
                ...
                var TPDescrip = $("#TipoPersona option:selected").text();
                if ((Anual + "").trim() == "" || (Modalidad + "").trim() == "" || (TipoPersona + "").trim() == "") {
                ...
                $.ajax({
                    url: '@Url.Action("TablaResultadosTipoPersona", "PrestamoFondoBibliografico")',
                type: 'GET',
                dataType: 'json',
                data: "Anual=" + Anual + "&Modalidad=" + Modalidad + "&TipoPersona=" + TipoPersona,
                ...
                error: function () {
                    ...
                    $("#RangoFecha").html("<span style='color:#4285f4;'>Año: " + Anual + "</span>&nbsp;&nbsp;&nbsp;<span style='color:#ea4335;'>Modalidad: " + ModDescrip + "</span>&nbsp;&nbsp;&nbsp;<span style='color:#fbbc05'>TipoPersona: " + TPDescrip + "</span>");
